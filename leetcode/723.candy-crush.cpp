 ...
 * positive integers board[r][c] represent different types of candies.  A value
 * of board[r][c] = 0 represents that the cell at position (r, c) is empty.
 ...
 * The length of board[r] will be in the range [3, 50].
 * Each board[r][c] will initially start as an integer in the range [1, 2000].
 *
 *
 */
class Solution {
