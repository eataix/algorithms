 ...
 * The address "255.0.0.7/32" specifies all addresses with a common prefix of
 * 32 bits to the given address,
 * ie. just this one address.
 *
 * The address "255.0.0.8/29" specifies all addresses with a common prefix of
 * 29 bits to the given address:
